...
question_list = ["Question 4704: Which of the following best describes how you cook in your home", "Question 410: What best describes the people you live with? READ OUT"]
...
def classData(path_to_txt = "/Users/Rishi/Downloads/file1.txt", path_to_csv = "/Users/Rishi/Documents/Master_folder/Semester_7/BTP/CER_both/CER Electricity Revised March 2012/Survey data - CSV format/Smart meters Residential pre-trial survey data.csv", question = "Question 43111: How many people under 15 years of age live in your home?"):
   ...
   # print (results)
files = ["/Users/Rishi/Downloads/file" + str(i) + ".txt" for i in range(1, 7)]
for f in files:
